...
import { settingSyncId, settingMigrateId, settingCommonId, staticNewItemTabs } from '../../common/constants'
...
export default class ItemList extends React.PureComponent {
  ...
  renderDelBtn = item => {
    if (!item.id || [settingSyncId, settingMigrateId, settingCommonId].includes(item.id) || item.id.startsWith('default')) {
      return null
    }
