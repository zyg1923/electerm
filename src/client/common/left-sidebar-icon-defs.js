 ...
 *
 * `text` is a locale key passed to window.translate. The "about" and
 * "hide sidebar" icons are always visible. Live file transfers stay
 * auto-shown; transfer history is a customizable sidebar icon.
 *
